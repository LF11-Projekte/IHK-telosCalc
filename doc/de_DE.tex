...
\begin{document}
	...
	\begin{center}
		\textbf{Hinweis:} Über geschweifte Klammern und Pipes werden verschiedene Optionen, resp. Auswahlmöglichkeiten dargestellt: \texttt{\{Option 1 | Option 2\}}. Ferner sei noch angemerkt, dass die ausführbare Windowsdatei \emph{je nach System bis zehn Sekunden und länger beim Starten zum Laden brauchen kann}.
	...
	\begin{enumerate}
		...
		\item Virtuelles Environment erzeugen: \texttt{python -m venv .venv} und aktivieren über:\\ \texttt{.\textbackslash.venv\textbackslash{}Scripts\textbackslash{}activate\textbackslash{}\{\ .bat | .ps1 | ␣\ \}}
	...
	Die Menüleiste (siehe Abbildung~\ref{fig:menu}) bietet die Optionen \texttt{Datei}, \texttt{Sprache}, \texttt{Erscheinungsbild} und \texttt{Hilfe}. Die in \texttt{Hilfe} befindlichen Optionen sind \texttt{Dokumentation}, welche ebendiese Dokumention verlinkt, und \texttt{Über}, welche Information über die Anwendung bereitstellt.
	...
	Mit der Option Sprachausgabe kann eine Audioausgabe zur Navigationshilfe aktiviert werden. Dabei wird beim "Mit-der-Maus-Hovern" über Elementen in der Regel ein Text angesagt. Ebenfalls beim Wechseln der \textsc{GUI}-Elemente mittels der \texttt{Tab}-Taste. Der Button \texttt{Noten Ansagen} wird zudem auch aktiviert. Bei dem Klicken auf dem Button werden alle Zwischennoten, der Gesamtnotendurchschnitt und das Prüfungsergebnis (also ob die Prüfung bestanden wurde) in der ausgewählten Zielsprache angesagt.
	
	Es kann durch alle Elemente, die zur Bedienung notwendig sind mittels der Tabulator-Taste "gegangen" werden. In das obere Menü gelangt man mittels der \texttt{Alt}-Taste -- in diesem kann man mit Pfeil-, Leer, und \texttt{Tabulator}-Taste navigieren und Elemente mit \texttt{Enter} bestätigen / auswählen. Mit der \texttt{Esc}-Taste kann man das obere Menü wieder verlassen.
